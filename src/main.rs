                                                                                    ...
                                                                                    .map(|item| {
                                                                                        ...
                                                                                        let err_height = if max_bar_value > 0 {
                                                                                            ((item.err as f32 / max_bar_value as f32) * 60.0)
                                                                                                .max(if item.err > 0 { 4.0 } else { 1.0 })
                                                                                        } else {
                                                                                            1.0
                                                                                        };
                                                                                        ...
                                                                                        view! {
                                                                                            <div
                                                                                                style="flex: 1; min-width: 0; display: flex; flex-direction: row; align-items: end; justify-content: center; gap: 6px;"
                                                                                                title=format!("{} | OK: {} | ERR: {} | TOTAL: {}", item.env_name, item.ok, item.err, item.total)
                                                                                            >
                                                                                                <div style="writing-mode: vertical-rl; transform: rotate(180deg); font-size: 0.56rem; font-weight: 900; color: #1e293b; line-height: 1; text-align: center; white-space: nowrap;">
                                                                                                    {item.env_name.clone()}
                                                                                                </div>
