                            ...
                            {move || {
                                health_resource.get().map(|res| match res {
                                    ...
                                    Ok(items) => {
                                        ...
                                        view! {
                                            <>
                                                <div style="display: grid; grid-template-columns: minmax(420px, 540px) 1fr; gap: 12px; margin-bottom: 14px;">
                                                                                        ...
                                                                                        view! {
                                                                                            <div style="flex: 1; min-width: 0; display: flex; flex-direction: column; align-items: center; justify-content: end; gap: 4px;" title=format!("{} | OK: {} | ERR: {} | TOTAL: {}", item.env_name, item.ok, item.err, item.total)>
                                                                                                <div
                                                                                                    ...
                                                                                                    style="width: 100%; display: flex; flex-direction: row; align-items: end; justify-content: center; gap: 6px; cursor: pointer;"
                                                                                                >
                                                                                                    <div style="writing-mode: vertical-rl; transform: rotate(180deg); font-size: 0.60rem; font-weight: 900; color: #1e293b; line-height: 1; white-space: nowrap;">
                                                                                                        {item.env_name.clone()}
                                                                                                    </div>

                                                                                                    <div style="display: flex; align-items: end; justify-content: center; gap: 4px; height: 64px;">
                                                                                                ...
                                                                                                <button
                                                                                                    ...
                                                                                                    style="margin-top: 2px; border: none; background: #2563eb; color: white; padding: 4px 8px; border-radius: 6px; cursor: pointer; font-weight: 700; font-size: 0.56rem;"
                                                                                                >
                                                                                                    "History"
                                                                                                </button>
                                                                                            </div>
