                                                                                    ...
                                                                                    .map(|item| {
                                                                                        ...
                                                                                        view! {
                                                                                            ...
                                                                                            >
                                                                                                ...
                                                                                                >
                                                                                                    <div style="display: grid; grid-template-columns: 56px 1fr; align-items: center; gap: 8px;">
                                                                                                        <div style="font-size: 0.64rem; font-weight: 900; color: #1e293b; line-height: 1; text-align: left;">
                                                                                                            {item.env_name.clone()}
                                                                                                        </div>

                                                                                                        <div style="display: flex; flex-direction: column; gap: 4px; min-width: 0;">
                                                                                                            <div style="display: flex; align-items: center; gap: 6px; width: 100%;">
                                                                                                                <div style="font-size: 0.50rem; font-weight: 800; color: #10b981; line-height: 1; min-width: 18px; text-align: right;">
                                                                                                                    {item.ok}
                                                                                                                </div>
                                                                                                            ...
                                                                                                            <div style="display: flex; align-items: center; gap: 6px; width: 100%;">
                                                                                                                <div style="font-size: 0.50rem; font-weight: 800; color: #ef4444; line-height: 1; min-width: 18px; text-align: right;">
                                                                                                                    {item.err}
                                                                                                                </div>
                                                                                                                <div style="height: 12px; flex: 1; background: #e2e8f0; border-radius: 999px; overflow: hidden;">
                                                                                                                    <div style=format!(
                                                                                                            ...
                                                                                                            <div style="font-size: 0.52rem; color: #64748b; text-align: right;">
