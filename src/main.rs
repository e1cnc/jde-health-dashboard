                                                                            ...
                                                                            .map(|item| {
                                                                                ...
                                                                                view! {
                                                                                    <details style="border: 1px solid #e2e8f0; border-radius: 10px; background: #f8fafc; overflow: hidden;">
                                                                                        <summary style="cursor: pointer; list-style: none; padding: 12px 14px; font-size: 0.82rem; font-weight: 800; color: #0f172a; display: flex; align-items: center; justify-content: space-between;">
                                                                                            <span>{instance_title}</span>
                                                                                            <span style="font-size: 0.72rem; color: #64748b; font-weight: 700;">"Click to expand"</span>
                                                                                        </summary>

                                                                                        <div style="padding: 0 14px 14px 14px; border-top: 1px solid #e2e8f0;">
                                                                                            <table style="width: 100%; border-collapse: collapse; margin-top: 10px; font-size: 0.82rem; color: #334155;">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td style="padding: 8px 10px; border: 1px solid #e2e8f0; background: #f1f5f9; font-weight: 700; width: 220px;">"Instance Name"</td>
                                                                                                        <td style="padding: 8px 10px; border: 1px solid #e2e8f0; background: white;">
                                                                                                            {item.instance_name.clone().unwrap_or_else(|| "-".to_string())}
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding: 8px 10px; border: 1px solid #e2e8f0; background: #f1f5f9; font-weight: 700;">"Instance Status"</td>
                                                                                                        <td style="padding: 8px 10px; border: 1px solid #e2e8f0; background: white;">
                                                                                                            {item.instance_status.clone().unwrap_or_else(|| "-".to_string())}
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding: 8px 10px; border: 1px solid #e2e8f0; background: #f1f5f9; font-weight: 700;">"Health Status"</td>
                                                                                                        <td style="padding: 8px 10px; border: 1px solid #e2e8f0; background: white;">
                                                                                                            {item.health_status.clone().unwrap_or_else(|| "-".to_string())}
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding: 8px 10px; border: 1px solid #e2e8f0; background: #f1f5f9; font-weight: 700;">"Details"</td>
                                                                                                        <td style="padding: 8px 10px; border: 1px solid #e2e8f0; background: white;">
