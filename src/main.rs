...
fn DoughnutChart(data: Vec<CustomerChartDatum>) -> impl IntoView {
    ...
    view! {
        <div style="height: 130px; max-width: 340px; margin: 0 auto; position: relative;">
        ...
        <>
            ...
            <div style="padding: 14px; background: #f8fafc; min-height: 100vh; font-family: Arial, sans-serif;">
                <div style="max-width: 1800px; margin: auto;">
                    ...
                    >
                        <div style="display: grid; grid-template-columns: 1fr auto 1fr; align-items: center; gap: 16px; margin-bottom: 14px;">
                            <div style="display: flex; gap: 4px; background: #f1f5f9; padding: 4px; border-radius: 8px; width: fit-content; justify-self: start;">
                                <button
                            ...
                            <h2 style="margin: 0; color: #1d4ed8; font-weight: 900; letter-spacing: 0.2px; font-size: 1.08rem; text-align: center; white-space: nowrap;">
                                "JDE Environment Health Dashboard"
                            </h2>

                            <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap; justify-self: end;">
